...
# =========================================
# 枕崎相場追記
# 5/20: 6わかば丸 670t -> 6.0上309.0/4.5上325.1/2.5上326.0/1.8上323.0/1.8下324.0/1.5上307.2/1.5下ダル混215.1
# 5/22: 88明豊丸 710t -> 6.0上327.0/4.5上348.8/2.5上341.9/1.8上335.9/1.8下328.0/1.5上310.0/1.5下ダル混220.0
# 5/27: 128福一丸 630t -> 6.0上328.7/4.5上332.8/2.5上319.9/1.8上315.5/1.5上305.0/1.5下ダル混220.5/0.5下310.0
# =========================================
...
if '1.5kg上' not in maku:
    maku['1.5kg上'] = []
if '1.5kg下ダル混' not in maku:
    maku['1.5kg下ダル混'] = []
if '0.5kg下' not in maku:
    maku['0.5kg下'] = []

add_if_new(maku['6.0kg上'], '2026-05-20', 309.0, 2.0, '6わかば丸')
add_if_new(maku['6.0kg上'], '2026-05-22', 327.0, 10.0, '88明豊丸')
add_if_new(maku['6.0kg上'], '2026-05-27', 328.7, 15.0, '128福一丸')

add_if_new(maku['4.5kg上'], '2026-05-20', 325.1, 10.0, '6わかば丸')
add_if_new(maku['4.5kg上'], '2026-05-22', 348.8, 50.0, '88明豊丸')
add_if_new(maku['4.5kg上'], '2026-05-27', 332.8, 35.0, '128福一丸')

add_if_new(maku['2.5kg上'], '2026-05-20', 326.0, 160.0, '6わかば丸')
add_if_new(maku['2.5kg上'], '2026-05-22', 341.9, 100.0, '88明豊丸')
add_if_new(maku['2.5kg上'], '2026-05-27', 319.9, 240.0, '128福一丸')

add_if_new(maku['1.8kg上'], '2026-05-20', 323.0, 140.0, '6わかば丸')
add_if_new(maku['1.8kg上'], '2026-05-22', 335.9, 100.0, '88明豊丸')
add_if_new(maku['1.8kg上'], '2026-05-27', 315.5, 30.0, '128福一丸')

add_if_new(maku['1.8kg下'], '2026-05-20', 324.0, 10.0, '6わかば丸')
add_if_new(maku['1.8kg下'], '2026-05-22', 328.0, 20.0, '88明豊丸')

add_if_new(maku['1.5kg上'], '2026-05-20', 307.2, 3.0, '6わかば丸')
add_if_new(maku['1.5kg上'], '2026-05-22', 310.0, 11.0, '88明豊丸')
add_if_new(maku['1.5kg上'], '2026-05-27', 305.0, 3.0, '128福一丸')

add_if_new(maku['1.5kg下ダル混'], '2026-05-20', 215.1, 2.0, '6わかば丸')
add_if_new(maku['1.5kg下ダル混'], '2026-05-22', 220.0, 5.0, '88明豊丸')
add_if_new(maku['1.5kg下ダル混'], '2026-05-27', 220.5, 1.0, '128福一丸')

add_if_new(maku['0.5kg下'], '2026-05-27', 310.0, 5.0, '128福一丸')
